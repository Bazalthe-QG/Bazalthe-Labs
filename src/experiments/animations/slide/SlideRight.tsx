...
export default function SlideRight() {
  ...
  return (
    ...
    <div className="overflow-hidden flex flex-col items-center gap-1">
      <div className="w-12 h-12 rounded-xl bg-indigo-500 transition-all duration-500"
        style={{ opacity: on ? 1 : 0, transform: on ? 'none' : 'translateX(40px)' }} />
