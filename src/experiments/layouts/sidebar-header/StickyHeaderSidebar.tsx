// Sticky header with scrollable sidebar content
...
export default function StickyHeaderSidebar() {
  ...
  return (
    <Frame>
      <div className="h-full flex flex-col">
        <div className="h-6 shrink-0 px-3 flex items-center gap-2 z-10 shadow-sm" style={nav}>
          <Line w="w-16" opacity={0.6} />
        </div>
        <div className="flex flex-1 overflow-hidden">
          <div className="w-14 shrink-0 p-1.5 overflow-y-auto flex flex-col gap-1" style={side}>
            {[1, 2, 3, 4, 5, 6, 7].map((i) => (
              <div
                key={i}
