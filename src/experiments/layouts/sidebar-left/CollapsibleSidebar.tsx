// Collapsible sidebar with collapse handle
  ...
  return (
    <Frame>
      <div className="h-full flex">
        <div className="w-20 shrink-0 p-2 flex flex-col gap-1.5 relative" style={side}>
          ...
          {[1, 2, 3].map((i) => (
            ...
            >
              <Dot />
              <Line w="w-full" opacity={i === 2 ? 0.8 : 0.4} />
            </div>
          ))}
          <div
            className="absolute right-0 top-1/2 -translate-y-1/2 w-3 h-6 rounded-l-full flex items-center justify-center"
            style={{ background: 'var(--c-border)' }}
          >
            <div className="w-1 h-1 rounded-full" style={{ background: 'var(--c-muted)' }} />
          </div>
        </div>
