// Sidebar with status bar footer
...
export default function StatusBarLayout() {
  ...
  return (
    <Frame>
      <div className="h-full flex flex-col">
        ...
        <div
          className="h-5 shrink-0 px-3 flex items-center gap-2"
          style={{ ...footer, background: 'rgba(109,40,217,0.08)' }}
        >
          <div className="w-1.5 h-1.5 rounded-full" style={{ background: '#10b981' }} />
          <Line w="w-12" opacity={0.4} />
          <Line w="w-10 ml-auto" opacity={0.3} />
        </div>
      </div>
    </Frame>
  )
